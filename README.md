# PMtutor Certification Quiz Engine
...
* **Target Benchmark:** Governed 80% passing score logic.
* **Diagnostic Analytics:** Real-time domain gap analysis.
* **Admin CSV Gateway:** Ingest new question banks directly into Firestore.
